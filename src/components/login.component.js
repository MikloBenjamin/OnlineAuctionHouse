                ...
                <div id="sign-in-form">
                    ...
                    <form action="/">
                        <label htmlFor="email">
                            ...
                            Email:</label>
                        <input className="form-input" type="text" name="email" autoComplete="off" required/><br/><br/>
                        <label htmlFor="pwd">
                            ...
                            Password:</label>
                        <input className="form-input" type="password" name="pwd" minLength="4" required/><br/><br/>
                        <input type="submit" value="Sign In"/>
                    </form>
                    <div>Dont have an account? <Link to="/register">Sign Up!</Link></div>
                </div>
